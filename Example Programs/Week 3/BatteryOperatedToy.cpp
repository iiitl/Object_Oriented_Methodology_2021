...
namespace example
{
	...
	void BatteryOperatedToy::put_batteries(string s, int i)
	{
	...
	void BatteryOperatedToy::take_out_all_batteries()
	{
		if(!batteries_installed)
	...
	bool BatteryOperatedToy::is_ready_for_playing()
	{
	...
	bool BatteryOperatedToy::is_being_played_with()
	{
		return in_use;
	}
}
